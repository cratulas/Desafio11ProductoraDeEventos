...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { duration: @concert.duration, group_id: @concert.group_id, number_of_attendees: @concert.number_of_attendees } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { duration: @concert.duration, group_id: @concert.group_id, number_of_attendees: @concert.number_of_attendees } }
